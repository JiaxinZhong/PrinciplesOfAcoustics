...
\begin{frame}{Reflection and Transmission Coefficients of Sound Intensity}
	\begin{outline}
		...
		$$r_I = \qty|\frac{I\st{r}}{I\st{i}} | = \frac{p\st{ra}^2}{2z_1}
		\bigg/ \frac{p\st{ia}^2}{2z_1} = r_p^2 
		= \qty(\frac{z_1-z_2}{z_1+z_2})^2 $$
		\1 transmission coefficient
		$$t_I = \qty|\frac{I\st{t}}{I\st{i}} | = \frac{p\st{ta}^2}{2z_1}
		\bigg/ \frac{p\st{ia}^2}{2z_1} = z_{21} t_p^2 
		= \qty(\frac{4z_1z_2}{(z_1+z_2)^2})$$
