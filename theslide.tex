...
\begin{frame}{Eulerian Method}{Total Derivative and Partial Derivative}
	...
	\1 or more concise
	\begin{align*}
	\vb{a} \equiv \dv{\vb{v}}{t} &=\lim_{\Delta t\to0} 
	\frac{\vb{v} (\vb{r}+\Delta\vb{r},t+\Delta t) - \vb{v}(\vb{r},t)}{
	\Delta t} \\
	&= \pdv{\vb{v}}{t}+ \qty(\lim_{\Delta t\to 0} \frac{\Delta \vb{r}}{
	\Delta t}\vdot \grad  )\vb{v}\\
	&= \pdv{\vb{v}}{t}+ \qty( \vb{v} \vdot \grad  )\vb{v}
	\end{align*}
\end{outline}
\end{frame}
