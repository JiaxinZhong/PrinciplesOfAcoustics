...
// background color in the region I
fill(box((-1+0.01,0.01), (-1/3-0.01,YMAX)), lightyellow);
// background color in the region II
fill(box((-XMIN/3-0.01,0.01), (XMIN/3+0.01,YMAX)), lightgreen);
// background color in the region III
fill(box((1/3+0.01,0.01), (1-0.01,YMAX)), lightblue);
